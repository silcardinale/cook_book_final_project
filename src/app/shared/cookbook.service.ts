...
export class CookbookService {
  public recipes : Recipe [] = [
      ...
      { name: 'Bastones de crema de maní', portions: 6, dificulty: 'Fácil', prepTime: 10, ingredients: '2 cdas de mantequilla de maní natural, 3 cdas de queso crema desnatado, 50g de chocolate semiamargo fundido.', procedure: 'Mezclar los 2 ingredientes y colocarlos en un recipiente de silicona para que sea fácil desmoldarlos. Llevar al freezer hasta que se congelen. Retirar del freezer, cortar en forma de bastones y terminar con chocolate fundido en la superficie.', img: 'assets/img/mani.jpg' },
