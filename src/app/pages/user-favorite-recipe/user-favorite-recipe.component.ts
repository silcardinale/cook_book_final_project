...
import { SearchRecipeService } from 'src/app/shared/search-recipe.service';
...
export class UserFavoriteRecipeComponent implements OnInit {
  ...
  public animation: boolean;
    ...
    constructor( private servicio: CookbookService, private router: Router,  private userService: UserService, private apiSearchRecipe: SearchRecipeService, private favService:  FavoriteService)
    {
